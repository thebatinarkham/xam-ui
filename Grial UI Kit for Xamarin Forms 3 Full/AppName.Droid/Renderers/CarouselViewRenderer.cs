/*
 * This file is an exact copy of this (expect for the _Fix suffix and the usage of the CirclePageIndicator_Fix
 * thanks to the "horizontal_viewpager_fix" and "vertical_viewpager_fix" layouts): 
 ...
 * Once a new version of the carousel is published this file can be removed.
 */
...
[assembly: ExportRenderer(typeof(CarouselViewControl), typeof(CarouselViewRenderer_Fix))]
namespace CarouselView.FormsPlugin.Android
{
    /// <summary>
    /// CarouselView Renderer
    /// </summary>
    public class CarouselViewRenderer_Fix : ViewRenderer<CarouselViewControl, AViews.View>
    {
        Context _context;
        ...
        ViewPager viewPager;
        CirclePageIndicator_Fix indicators;
        ...
        public CarouselViewRenderer_Fix(Context context) : base(context)
        {
            _context = context;
        ...
        void SetNativeView()
        {
            ...
            // INDICATORS
            indicators = nativeView.FindViewById<CirclePageIndicator_Fix>(Resource.Id.indicator);
            SetIndicators();
        }
