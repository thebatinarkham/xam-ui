/*
 * This file is an exact copy of this (expect for the _Fix suffix): 
 * https://github.com/alexrainman/CirclePageIndicator/blob/master/Com.ViewPagerIndicator/CirclePageIndicator.cs
 * The reason for this copy is this carousel view issue: 
 * https://github.com/alexrainman/CarouselView/issues/489
 * It's fixed in this separate page indicator but there's no version published of the carouself itself just yet.
 * Once a new version of the carousel is published this file can be removed along with the "horizontal_viewpager_fix.xaml" and
 * "vertical_viewpager_fix.xaml" layouts.
 */
...
{
    public class CirclePageIndicator_Fix : ViewGroup, PageIndicator
    {
        ...
        public CirclePageIndicator_Fix(Context context) : this(context, null)
        {
        }

        public CirclePageIndicator_Fix(IntPtr intPtr, JniHandleOwnership jni) : base(intPtr, jni)
        {
        }

        public CirclePageIndicator_Fix(Context context, IAttributeSet attrs) : this(context, attrs, Resource.Attribute.vpiCirclePageIndicatorStyle)
        {
        }

        public CirclePageIndicator_Fix(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
